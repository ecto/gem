...
- [ ] Clear memory (optional): `rm memory/*.jsonl`
- [ ] Ensure `theta.json` is in default state (weak system prompt).
- [ ] Run: `export OPENAI_API_KEY=sk-... && npm start`
...
2.  **Trigger Self-Improvement**
    ...
    - _Narrative_: "The agent introspected on the Reference Suite, realized it was failing the style guidelines, and proposed a configuration change. The Runtime Executive tested this patch in a sandbox, verified the score improvement, and committed the change."
